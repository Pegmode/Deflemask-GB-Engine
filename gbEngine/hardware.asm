...
;*
;* Rev 2.4P - 09-Feb-17: Added cart types found post 1998
...
waveBuffer		EQU	$FF30	; because I felt like it
...
;Values in variable name are in x bits
CART_ROM_256K  EQU 0 ;32KB = 2 banks
CART_ROM_512K  EQU 1 ;64KB = 4 banks
CART_ROM_1M    EQU 2 ;128KB = 8 banks
CART_ROM_2M    EQU 3 ;256KB = 16 banks
CART_ROM_4M    EQU 4 ;512KB = 32 banks
CART_ROM_8M    EQU 5 ;1MB = 64 banks
CART_ROM_16M   EQU 6 ;2MB = 128 banks		;There are other rom sizes but this is sufficient


CART_RAM_NONE  EQU 0 
CART_RAM_16K   EQU 1 ;2kB
CART_RAM_64K   EQU 2 ;8kB
CART_RAM_256K  EQU 3 ;32kB
CART_RAM_DISABLE  EQU $00 ;128kB
...
scrWidth_pixels		EQU	160
scrHeight_pixels	EQU	144
scrWidth_tiles		EQU	20
scrHeight_tiles		EQU	18
...
mapWidth_pixels		EQU	256
mapHeight_pixels	EQU 256
mapWidth_tiles		EQU	32
mapHeight_tiles		EQU	32
